# project-frontend-movie-card-library

## Meus Comentários

Este foi um projeto individual feito na Trybe no Módulo de Front-end onde fui apresentado ao React e pude exercitar a criação de diversos componentes.
